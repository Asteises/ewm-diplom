...
(
    ...
    loc_id   BIGINT,
    event_id BIGINT,
    CONSTRAINT location_events_PK PRIMARY KEY (id),
    CONSTRAINT location_events_comp_id_FK FOREIGN KEY (loc_id) REFERENCES locations ON DELETE CASCADE,
    CONSTRAINT location_events_event_id_FK FOREIGN KEY (event_id) REFERENCES events
);
